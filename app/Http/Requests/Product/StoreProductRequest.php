...
class StoreProductRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->user()->hasRole('Super Admin') || $this->user()->hasPermission('products.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'inventory_type' => ['required', Rule::in(['raw_material', 'finished_good', 'consumable', 'packaging'])],
